        ...
        <div className="container-fluid bg-dark mb-30">
            <div className="row px-xl-5">
                <div className="col-lg-3 d-none d-lg-block">
                    ...
                    <nav className="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style={{ width: "calc(100% - 30px)" }}>
                    ...
                    <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                        ...
                        <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div className="navbar-nav mr-auto py-0">
                                ...
                                <NavLink to="/shoplist" className="nav-item nav-link">Shop</NavLink>
                                <div className="nav-item dropdown">
                                    ...
                                    <div className="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                        <NavLink to="/shopingcart" className="dropdown-item">Shopping Cart</NavLink>
                            ...
                            <div className="navbar-nav ml-auto py-0 d-none d-lg-block">
                                ...
                                <a href="" className="btn px-0 ml-3">
                                    <NavLink to="/shopingcart"><i className="fas fa-shopping-cart text-primary"></i></NavLink>
                                    <span className="badge text-secondary border border-secondary rounded-circle" style={{ paddingBottom: "2px" }}>{total_item}</span>
                                </a>
                                {isAuthenticated ? (
                                    <a href="" className="btn px-0 ml-3">
                                        <NavLink onClick={() => logout({ logoutParams: { returnTo: window.location.origin } })}><i class="fas fa-sign-out-alt"></i></NavLink>
                                        <span className="badge text-secondary border border-secondary rounded-circle" style={{ paddingBottom: "2px" }}></span>
                                    </a>

                                ) : (<a href="" className="btn px-0 ml-3">
                                    <NavLink onClick={() => loginWithRedirect()}><i class="fas fa-user"></i></NavLink>
                                    <span className="badge text-secondary border border-secondary rounded-circle" style={{ paddingBottom: "2px" }}></span>
                                </a>)}
